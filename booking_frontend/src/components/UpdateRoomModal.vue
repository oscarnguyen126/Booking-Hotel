    ...
    <form class="form" @submit.prevent="onSubmit">
      <div>
        <div class="input-group">
          ...
          <input v-model="form.name" type="text" id="name" name="name" placeholder="Room name" required />
        </div>
        ...
        <div class="input-group">
          ...
          <input v-model="form.price" type="number" id="price" name="price" placeholder="Price" />
        </div>

        <div class="input-group">
          <label class="input-label" for="img">Image</label>
          <input id="img" type="file" @change="onFileChanged($event)" accept="image/*" capture />
        </div>

        <div class="input-group">
          <label class="input-label">Facilities</label>
          <div class="facility-checkbox-group">
            <div class="facility-checkbox-input" v-for=" item in listFacs">
              <input v-model="form.facilities" type="checkbox" name="facs" :value="item.name" :id="item.id" />
